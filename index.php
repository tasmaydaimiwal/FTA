...
<div id="portfolio" class="portfolio">
   <div class="top-tours-head text-center">
	      ...
	      <ul id="filters" class="clearfix wow bounceIn" data-wow-delay="0.4s">
			...
			<li><span class="filter" data-filter="card">Travel</span></li>
			<li><span class="filter" data-filter="icon">Accomodation</span></li>
			<!--<li><span class="filter" data-filter="fun">Other</span></li>-->
	        </ul>
	     <div id="portfoliolist">
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
							<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
						     <img src="images/.jpg" class="img-responsive" alt=""/></a>
							</div>
					</div>
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 ...
					 <p><a href="https://code-projects.org/">Brought To You By MES-IMCC</a></p>
				 </div>
				<?php if($n%4==3)
				{?>
            </div>
...
<div id="section-5" class="contact section">
	  <div class="contact-head text-center">
          ...
          <h4 style="color:#000"> We Will Help To Make Decisions </h4>

		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">FTA ENTERPRISES</h4>
						<p style="color:#000">NEED HELP !!!<br/>
                        For fantastic suggestions you may also call our expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 9876543210&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;9874561230</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">www.mes-imcc.com &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;www.mes-imcc.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Kothrud, Mayur Colony</h5>
                        <br/>
...
<script type="text/javascript">
    ...
    window.__be.id = "645cd2040988a000074909d2";
    (function() {
